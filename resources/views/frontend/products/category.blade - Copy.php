                        ...
                        <div class="tab-content jump">
                            ...
                            <div id="shop-1" class="tab-pane active">
                                <div class="row">
                                    ...
                                    <div v-for="row in data" class="col-xl-3 col-md-6 col-lg-4 col-sm-6 col-xs-12">
                                        <article class="list-product">
                                            ...
                                            <div class="product-decs">
                                                ...
                                                <h2><a href="" class="product-link">@{{row.title}}</a></h2>
                                                ...
                                                <div class="pricing-meta">
                                                    <ul>
                                                        ...
                                                        <li class="old-price"> {{$siteSetting['currency_symble']}}@{{row.selling_price}}</li>
                                                        <li class="current-price">{{$siteSetting['currency_symble']}} @{{row.selling_price-(row.discount*row.selling_price)/100 }}</li>
                                                        <li class="discount-price">-@{{row.discount}}%</li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                    <div class="product-desc-wrap">
                                                        <div class="product-decs">
                                                            <a class="inner-link" href="category.php"><span>GRAPHIC CORNER</span></a>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                                    <div class="left-img">
                                                        <div class="img-block">
                                                            <a href="{{ route('product_details') }}" class="thumbnail">
                                                                <img class="first-img" src="{{asset('frontend')}}/images/product-image/organic/product-5.jpg" alt="" />
                                                                <img class="second-img" src="{{asset('frontend')}}/images/product-image/organic/product-5.jpg" alt="" />
                                                            </a>
                                                            <div class="quick-view">
                                                                <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-toggle="modal" data-target="#exampleModal">
                                                                    <i class="ion-ios-search-strong"></i>
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                    <div class="product-desc-wrap">
                                                        <div class="product-decs">
                                                            <a class="inner-link" href="category.php"><span>GRAPHIC CORNER</span></a>
                                                            <h2><a href="{{ route('product_details') }}" class="product-link">Juicy Couture Tricot Logo Stripe Jacket</a></h2>
                                                            <div class="rating-product">
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                                    <div class="left-img">
                                                        <div class="img-block">
                                                            <a href="{{ route('product_details') }}" class="thumbnail">
                                                                <img class="first-img" src="{{asset('frontend')}}/images/product-image/organic/product-19.jpg" alt="" />
                                                                <img class="second-img" src="{{asset('frontend')}}/images/product-image/organic/product-20.jpg" alt="" />
                                                            </a>
                                                            <div class="quick-view">
                                                                <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-toggle="modal" data-target="#exampleModal">
                                                                    <i class="ion-ios-search-strong"></i>
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                    <div class="product-desc-wrap">
                                                        <div class="product-decs">
                                                            <a class="inner-link" href="category.php"><span>STUDIO DESIGN</span></a>
                                                            <h2><a href="{{ route('product_details') }}" class="product-link">New Balance Fresh Foam LAZR v1 Sport</a></h2>
                                                            <div class="rating-product">
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                    <div class="product-desc-wrap">
                                                        <div class="product-decs">
                                                            <a class="inner-link" href="category.php"><span>GRAPHIC CORNER</span></a>
                                                            <h2><a href="{{ route('product_details') }}" class="product-link">Juicy Couture Solid Sleeve Puffer Jacket</a></h2>
                                                            <div class="rating-product">
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                                    <div class="left-img">
                                                        <div class="img-block">
                                                            <a href="{{ route('product_details') }}" class="thumbnail">
                                                                <img class="first-img" src="{{asset('frontend')}}/images/product-image/organic/product-23.jpg" alt="" />
                                                                <img class="second-img" src="{{asset('frontend')}}/images/product-image/organic/product-22.jpg" alt="" />
                                                            </a>
                                                            <div class="quick-view">
                                                                <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-toggle="modal" data-target="#exampleModal">
                                                                    <i class="ion-ios-search-strong"></i>
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                    <div class="product-desc-wrap">
                                                        <div class="product-decs">
                                                            <a class="inner-link" href="category.php"><span>GRAPHIC CORNER</span></a>
                                                            <h2><a href="{{ route('product_details') }}" class="product-link">New Balance Fresh Foam Kaymin</a></h2>
                                                            <div class="rating-product">
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                    <div class="product-desc-wrap">
                                                        <div class="product-decs">
                                                            <a class="inner-link" href="category.php"><span>GRAPHIC CORNER</span></a>
                                                            <h2><a href="{{ route('product_details') }}" class="product-link">Water and Wind Resistant Insulated Jacket</a></h2>
                                                            <div class="rating-product">
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                                    <div class="left-img">
                                                        <div class="img-block">
                                                            <a href="{{ route('product_details') }}" class="thumbnail">
                                                                <img class="first-img" src="{{asset('frontend')}}/images/product-image/organic/product-16.jpg" alt="" />
                                                                <img class="second-img" src="{{asset('frontend')}}/images/product-image/organic/product-17.jpg" alt="" />
                                                            </a>
                                                            <div class="quick-view">
                                                                <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-toggle="modal" data-target="#exampleModal">
                                                                    <i class="ion-ios-search-strong"></i>
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                    <div class="product-desc-wrap">
                                                        <div class="product-decs">
                                                            <a class="inner-link" href="category.php"><span>STUDIO DESIGN</span></a>
                                                            <h2><a href="{{ route('product_details') }}" class="product-link">Trans-Weight Hooded Wind and Water Resistant Shell</a></h2>
                                                            <div class="rating-product">
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                    <div class="product-desc-wrap">
                                                        <div class="product-decs">
                                                            <a class="inner-link" href="category.php"><span>GRAPHIC CORNER</span></a>
                                                            <h2><a href="{{ route('product_details') }}" class="product-link">Calvin Klein Jeans Reflective Logo Full Zip</a></h2>
                                                            <div class="rating-product">
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                    <div class="product-desc-wrap">
                                                        <div class="product-decs">
                                                            <a class="inner-link" href="category.php"><span>GRAPHIC CORNER</span></a>
                                                            <h2><a href="{{ route('product_details') }}" class="product-link">Brixton Patrol All Terrain Anorak Jacket</a></h2>
                                                            <div class="rating-product">
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                    <div class="product-desc-wrap">
                                                        <div class="product-decs">
                                                            <a class="inner-link" href="category.php"><span>STUDIO DESIGN</span></a>
                                                            <h2><a href="{{ route('product_details') }}" class="product-link">Juicy Couture Juicy Quilted Terry Track Jacket</a></h2>
                                                            <div class="rating-product">
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                    <div class="product-desc-wrap">
                                                        <div class="product-decs">
                                                            <a class="inner-link" href="category.php"><span>STUDIO DESIGN</span></a>
                                                            <h2><a href="{{ route('product_details') }}" class="product-link">Originals Kaval Windbreaker Winter Jacket</a></h2>
                                                            <div class="rating-product">
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                                    <div class="left-img">
                                                        <div class="img-block">
                                                            <a href="{{ route('product_details') }}" class="thumbnail">
                                                                <img class="first-img" src="{{asset('frontend')}}/images/product-image/organic/product-10.jpg" alt="" />
                                                                <img class="second-img" src="{{asset('frontend')}}/images/product-image/organic/product-10.jpg" alt="" />
                                                            </a>
                                                            <div class="quick-view">
                                                                <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-toggle="modal" data-target="#exampleModal">
                                                                    <i class="ion-ios-search-strong"></i>
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                    <div class="product-desc-wrap">
                                                        <div class="product-decs">
                                                            <a class="inner-link" href="category.php"><span>GRAPHIC CORNER</span></a>
                                                            <h2><a href="{{ route('product_details') }}" class="product-link">New Luxury Men's Slim Fit Shirt Short Sleeve...</a></h2>
                                                            <div class="rating-product">
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                                    <div class="left-img">
                                                        <div class="img-block">
                                                            <a href="{{ route('product_details') }}" class="thumbnail">
                                                                <img class="first-img" src="{{asset('frontend')}}/images/product-image/organic/product-4.jpg" alt="" />
                                                                <img class="second-img" src="{{asset('frontend')}}/images/product-image/organic/product-4.jpg" alt="" />
                                                            </a>
                                                            <div class="quick-view">
                                                                <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-toggle="modal" data-target="#exampleModal">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                    <div class="product-desc-wrap">
                                                        <div class="product-decs">
                                                            <a class="inner-link" href="category.php"><span>GRAPHIC CORNER</span></a>
                                                            <h2><a href="{{ route('product_details') }}" class="product-link">Brixton Patrol All Terrain Anorak Jacket 2</a></h2>
                                                            <div class="rating-product">
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                    <div class="product-desc-wrap">
                                                        <div class="product-decs">
                                                            <a class="inner-link" href="category.php"><span>GRAPHIC CORNER</span></a>
                                                            <h2><a href="{{ route('product_details') }}" class="product-link">Juicy Couture Juicy Quilted Terry Track Jacket 2</a></h2>
                                                            <div class="rating-product">
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
...
@section('js')
   <script>
         ...
         var app = new Vue({
            ...
            methods:{
                getData(){
                axios.get('{{route("home.apicategory", Request::route("catslug"))}}?page='+this.pagination.current_page)
                  .then(response => {
