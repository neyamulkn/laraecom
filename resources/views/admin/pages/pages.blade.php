                            ...
                            <div class="row justify-content-md-center">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input disabled="" required="" type="text"  id="slugEdit" name="slug"  class="form-control" ><span style="color:red;cursor:pointer" class="slug" onclick="enable()">Edit slug</span>
                                    </div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <label style="background: #fff;top:-10px;z-index: 1" for="page_dsc">Page Description</label>
                                        <textarea name="page_dsc" class="summernote form-control" id="page_dsc" rows="5">{{old('page_dsc')}}</textarea>
                                    </div>
                                </div>

                               
                                <div class="col-md-10 "> <span>Select Menu</span></div>
                                <div class="col-md-10 ">

                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" id="show_header" name="show_header" class="custom-control-input">
                                        <label class="custom-control-label" for="show_header">Show Header Menu</label>
                                    </div>

                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" id="show_footer" name="show_footer" class="custom-control-input">
                                        <label class="custom-control-label" for="show_footer">Show Footer Menu</label>
                                    </div>
