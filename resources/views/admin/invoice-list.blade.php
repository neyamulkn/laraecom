...
@section('content')
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        ...
                        <button type="button" data-toggle="modal" data-target="#add-invoice" class="btn btn-info d-none d-lg-block m-l-15"><i
                                class="fa fa-plus-circle"></i> Create New invoice</button>
                    </div>
                </div>
            </div>
                                ...
                                <table id="demo-foo-addrow" class="table table-hover contact-list"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a target="_blnak" href="{{route('user.profile',$invoice->user->username)}}"> {{$invoice->user->name}}</a></td>
                                            ...
                                            <td>
                                                <a title="View" href="{{route('invoice.view', $invoice->invoice_id)}}" class="btn btn-success btn-sm"><i class="ti-eye"></i></a>
                                                <button title="Edit invoice" type="button" onclick="edit(2)"  data-toggle="modal" data-target="#edit" class="btn btn-info btn-sm"><i class="ti-pencil" aria-hidden="true"></i></button>
                                                <button title="Delete invoice" data-target="#delete" onclick="confirmPopup(2)" class="btn btn-danger btn-sm" data-toggle="modal"><i class="ti-trash" aria-hidden="true"></i> </button>
                                            </td>
                                        </tr>
                                        @endforeach
    ...
    <div class="modal fade" id="add-invoice" role="dialog"  tabindex="-1" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body form-row">
                    <div class="card-body">
                        <form action="{{route('invoice.store')}}" method="POST" class="floating-labels">
                            {{csrf_field()}}
                            <div class="form-body">
                                <!--/row-->
                                ...
                                <div class="row justify-content-md-center">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="pay_method">invoice Method</label>
